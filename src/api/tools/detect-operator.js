// src/api/tools/detect-operator.js
import { createApiKeyMiddleware } from "../../middleware/apikey.js";

// Fungsi deteksi operator (sama persis seperti aslinya)
...
export default (app) => {
  async function handleDetectOperator(req, res) {
    ...
    try {
      ...
      console.error("[Detect Operator Error]:", error.message);
      res.status(500).json({
        status: false,
        error: "Gagal mendeteksi operator",
      });
    }
  }

  app.get("/v1/tools/detect-operator", createApiKeyMiddleware(), handleDetectOperator);
  app.post("/v2/tools/detect-operator", createApiKeyMiddleware(), handleDetectOperator);
};
